...
Portero= createobject('_Portero')

LOCAL obj,temp,aDatos,nCant
dimension aDatos(2)
obj=createobject("Conf_General")
temp=obj.consultacompleta()
release obj
...
LOCAL oAfi
oAfi= createobject('entidad_afiliados')
nCant=oAfi.archivo_afil_dasu(aDatos)

*!*	SELECT &temp
*!*	COPY TO 'suspendidos_'+TTOC(DATETIME(),1)+'.xls' TYPE XL5
